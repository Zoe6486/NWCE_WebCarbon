...
# 导入 paths 模块中的路径变量
from paths import WEBSITES_ORIGINAL_DIR, CSS_OPTI_DIR
...
SOURCE_OPTIMIZED_CSS_DIR = CSS_OPTI_DIR / "css_optimized" / PROJECT_NAME
RESULT_DIR = CSS_OPTI_DIR / "websites_optimized" / PROJECT_NAME

OPTIMIZED_CSS_PATH = SOURCE_OPTIMIZED_CSS_DIR / "style.css"
