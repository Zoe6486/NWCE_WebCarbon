...
# 导入 paths 模块中的路径变量
from paths import WEBSITES_ORIGINAL_DIR, IMAGE_OPTI_DIR, API_BASE_URL, API_KEY
...
RESULT_DIR = os.path.join(IMAGE_OPTI_DIR, "image_llm_suggestions", PROJECT_NAME)
SUGGESTIONS_FILE_PATH = os.path.join(RESULT_DIR, "image_optimization_suggestions.json")
CSV_SUGGESTIONS_FILE_PATH = os.path.join(RESULT_DIR, "image_optimization_summary.csv")
