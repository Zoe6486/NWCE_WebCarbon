...
SOURCE_JS_DIR = os.path.join(JS_OPTI_DIR, "js_original", PROJECT_NAME)
SUGGESTIONS_DIR = os.path.join(JS_OPTI_DIR, "js_llm_suggestions", PROJECT_NAME)
RESULT_DIR = os.path.join(JS_OPTI_DIR, "js_optimized", PROJECT_NAME)
REPORT_DIR = os.path.join(JS_OPTI_DIR, "optimization_report", PROJECT_NAME)
