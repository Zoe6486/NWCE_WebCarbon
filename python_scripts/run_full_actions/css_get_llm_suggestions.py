...
# 导入 paths 模块中的路径变量
from paths import ROOT_DIR, FULL_OPTI_DIR, API_BASE_URL, API_KEY
...
SOURCE_DIR = SOURCE_TEMP_DIR / "css_original"
SUGGESTIONS_DIR = SOURCE_TEMP_DIR / "css_llm_suggestions"
